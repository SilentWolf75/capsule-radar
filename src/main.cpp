...
static void handleRoot() {
    ...
    const int needed = snprintf(buf, BUFSZ,
        ...
        ".dot-box{position:relative;width:56px;height:56px;border-radius:50%%;padding:2px;"
        "background:linear-gradient(145deg,#2c302f,#0c0e0d);box-shadow:0 0 16px rgba(29,255,134,.35);flex:0 0 auto}"
        ".dot-scope{position:relative;width:100%%;height:100%%;border-radius:50%%;background:#000;overflow:hidden;border:1.5px solid rgba(29,255,134,.7);box-shadow:inset 0 0 12px rgba(0,40,20,.8)}"
        ".dot-sweep{position:absolute;inset:0;border-radius:50%%;background:conic-gradient(from 0deg,rgba(29,255,134,.6) 0deg,rgba(29,255,134,.08) 50deg,transparent 65deg);"
        "animation:sw 3.6s linear infinite;transform-origin:center;pointer-events:none}"
        ".dot-rings{position:absolute;inset:0;width:100%%;height:100%%;pointer-events:none}"
        ...
        "</style></head><body>"
        "<div class=hd><div class=dot-box><div class=dot-scope>"
        "<svg class=dot-rings viewBox='0 0 100 100'>"
        "<circle cx=50 cy=50 r=46 fill=none stroke='rgba(29,255,134,0.4)' stroke-width=2/>"
        "<circle cx=50 cy=50 r=30 fill=none stroke='rgba(29,255,134,0.25)' stroke-width=1/>"
        "<circle cx=50 cy=50 r=15 fill=none stroke='rgba(29,255,134,0.25)' stroke-width=1/>"
        "<line x1=50 y1=4 x2=50 y2=96 stroke='rgba(29,255,134,0.25)' stroke-width=1 stroke-dasharray='2,2'/>"
        "<line x1=4 y1=50 x2=96 y2=50 stroke='rgba(29,255,134,0.25)' stroke-width=1 stroke-dasharray='2,2'/>"
        "<g transform='translate(68,32)' fill='#c8ff3c'><path d='M0,-5 L1,0 L5,2 L1,2 L2,5 L0,4 L-2,5 L-1,2 L-5,2 L-1,0 Z' transform='rotate(225)'/></g>"
        "<g transform='translate(30,68)' fill='#3ce0ff'><path d='M0,-5 L1,0 L5,2 L1,2 L2,5 L0,4 L-2,5 L-1,2 L-5,2 L-1,0 Z' transform='rotate(90)'/></g>"
        "</svg>"
        "<div class=dot-sweep></div>"
        "</div></div><div><h1>Capsule Radar</h1><p class=sub>Live ADS-B radar &middot; configuration</p></div></div>"
