...
static void handleRoot() {
    ...
    const int needed = snprintf(buf, BUFSZ,
        ...
        ".sweep{transform-origin:233px 233px;animation:spin 5.0s linear infinite}"
        "@keyframes spin{to{transform:rotate(360deg)}}"
        ".ac1{animation:glow-ac1 5.0s linear infinite}.ac2{animation:glow-ac2 5.0s linear infinite}.ac3{animation:glow-ac3 5.0s linear infinite}"
