...
static void handleRoot() {
    ...
    const int needed = snprintf(buf, BUFSZ,
        ...
        "background:linear-gradient(145deg,#2c302f,#0c0e0d);box-shadow:0 0 16px rgba(29,255,134,.35);"
        "overflow:hidden;flex:0 0 auto}"
        ".dot-svg{width:100%%;height:100%%;display:block}"
        ".sw-g{transform-origin:50px 50px;animation:sw 4s linear infinite}"
        ...
        "</style></head><body>"
        "<svg style='display:none'><defs><linearGradient id=swg x1=0 y1=0 x2=1 y2=0>"
        "<stop offset=0%% stop-color='#1dff86' stop-opacity=0/>"
        "<stop offset=100%% stop-color='#1dff86' stop-opacity=.35/>"
        "</linearGradient></defs></svg>"
        "<div class=hd><div class=dot-box><svg viewBox='0 0 100 100' class=dot-svg>"
        "<circle cx=50 cy=50 r=46 fill=none stroke='#1dff86' stroke-opacity=.4 stroke-width=1.5/>"
        "<circle cx=50 cy=50 r=30 fill=none stroke='#1dff86' stroke-opacity=.26/>"
        "<circle cx=50 cy=50 r=15 fill=none stroke='#1dff86' stroke-opacity=.26/>"
        "<line x1=50 y1=4 x2=50 y2=96 stroke='#1dff86' stroke-opacity=.2/>"
        "<line x1=4 y1=50 x2=96 y2=50 stroke='#1dff86' stroke-opacity=.2/>"
        "<g class=sw-g><path d='M50,50 L30,6 A46,46 0 0 1 70,6 Z' fill='url(#swg)'/>"
        "<line x1=50 y1=50 x2=70 y2=6 stroke='#3dff9a' stroke-width=1.5/></g>"
        ...
        "</svg></div><div><h1>Capsule Radar</h1><p class=sub>Live ADS-B radar &middot; configuration</p></div></div>"
