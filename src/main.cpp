...
static void handleRoot() {
    ...
    const int needed = snprintf(buf, BUFSZ,
        ...
        ".sweep{transform-origin:233px 233px;animation:spin 4.2s linear infinite}"
        ...
        "<linearGradient id=sweepGrad x1='0' y1='0' x2='1' y2='0'><stop offset='0%%' stop-color='#1dff86' stop-opacity='0'/><stop offset='78%%' stop-color='#1dff86' stop-opacity='0.09'/><stop offset='100%%' stop-color='#1dff86' stop-opacity='0.30'/></linearGradient>"
        "</defs></svg>"
        ...
        "<g class=sweep><path d='M233,233 L140,33.6 A220,220 0 0 1 326,33.6 Z' fill='url(#sweepGrad)'/><line x1='233' y1='233' x2='326' y2='33.6' stroke='#3dff9a' stroke-width='2' stroke-opacity='0.85' filter='url(#glow)'/></g>"
        "<g font-family='sans-serif' font-weight='700' text-anchor='middle'><text x='233' y='40' font-size='20' fill='#eafff3'>N</text><text x='233' y='441' font-size='17' fill='#9affc8'>S</text><text x='35' y='239' font-size='17' fill='#9affc8'>W</text><text x='431' y='239' font-size='17' fill='#9affc8'>E</text></g>"
        "<g font-family='monospace'><g transform='translate(322,150)' style='color:#c8ff3c'><path d='M0,0 L26,26' stroke='#c8ff3c' stroke-width='2' stroke-opacity='0.22' stroke-dasharray='2 5'/><path d='M0,-9 L2,-1 L9,3 L2,3 L3,8 L0,6.5 L-3,8 L-2,3 L-9,3 L-2,-1 Z' fill='#c8ff3c' transform='rotate(225)'/></g><g transform='translate(252,74)' style='color:#3ce0ff'><path d='M0,0 L0,-26' stroke='#3ce0ff' stroke-width='2' stroke-opacity='0.22' stroke-dasharray='2 5'/><path d='M0,-9 L2,-1 L9,3 L2,3 L3,8 L0,6.5 L-3,8 L-2,3 L-9,3 L-2,-1 Z' fill='#3ce0ff' transform='rotate(180)'/></g><g transform='translate(118,236)' style='color:#ffb23c'><path d='M0,0 L-26,-4' stroke='#ffb23c' stroke-width='2' stroke-opacity='0.22' stroke-dasharray='2 5'/><path d='M0,-9 L2,-1 L9,3 L2,3 L3,8 L0,6.5 L-3,8 L-2,3 L-9,3 L-2,-1 Z' fill='#ffb23c' transform='rotate(90)'/></g></g>"
